import { d as O, c as i, r as _, o as q, a as c, b as m, e as a, t as r, f as z, w as h, v as S, F as w, g as B, h as C, i as F, j as A } from "./main-b124380c.js";
import { I as E } from "./IdentityIcon-ed813c43.js";
import { T as g } from "./TokenUnitConverter-f6a69529.js";
const J = { class: "form-control" }, L = { class: "label" }, P = { class: "label-text" }, $ = { class: "flex p-2" }, G = { class: "ml-2 text-base" }, H = { class: "form-control" }, K = { class: "label" }, Q = { class: "label-text" }, R = { value: "" }, W = ["value"], X = { class: "form-control" }, Y = { class: "label" }, Z = { class: "label-text" }, ee = { class: "join" }, te = ["placeholder"], ae = ["value"], le = /* @__PURE__ */ O({
  __name: "Burn",
  props: {
  ...
  setup(f, { expose: j, emit: T }) {
    ...
    return q(() => {
      ...
      return c(), m("div", null, [
        a("div", J, [
          a("label", L, [
            a("span", P, r(d("your_connected_account")), 1)
          ]),
          a("div", $, [
            z(E, {
              size: "small",
        ...
        a("div", X, [
          ...
          a("label", ee, [
            h(a("input", {
              ...
              type: "number",
              placeholder: `Available: ${(v = y.value) == null ? void 0 : v.display.amount}`,
