import { d as x, c as d, r as u, o as g, a as y, b as S, e, t as a, f as k, w as I, h as P, i as V, x as w } from "./main-a00ca3ce.js";
import { I as B } from "./IdentityIcon-ebc7f7f3.js";
const C = { class: "form-control" }, M = { class: "label" }, N = { class: "label-text" }, O = { class: "flex p-2" }, j = { class: "ml-2 text-base" }, q = { class: "form-control" }, D = { class: "label" }, U = { class: "label-text" }, z = { class: "form-control text-right" }, E = { class: "label" }, F = { class: "label-text" }, A = /* @__PURE__ */ x({
  __name: "CreateProof",
  props: {
