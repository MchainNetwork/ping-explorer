import { d as g, c as d, r as u, o as x, a as y, b as S, e, t as a, f as k, w as I, h as P, i as V, s as w } from "./main-45275fe0.js";
import { I as B } from "./IdentityIcon-a4ae70c2.js";
const C = { class: "form-control" }, M = { class: "label" }, N = { class: "label-text" }, O = { class: "flex p-2" }, j = { class: "ml-2 text-base" }, q = { class: "form-control" }, D = { class: "label" }, U = { class: "label-text" }, z = { class: "form-control text-right" }, E = { class: "label" }, F = { class: "label-text" }, A = /* @__PURE__ */ g({
  ...
  setup(r, { expose: p, emit: f }) {
    ...
    return x(() => {
      f("loaded");
    }), p({ msgs: _, isValid: h, initial: v }), (s, t) => (y(), S("div", null, [
      e("div", C, [
        e("label", M, [
      ...
      e("div", q, [
        ...
        I(e("input", {
          ref_key: "focusInput",
          ref: i,
          "onUpdate:modelValue": t[0] || (t[0] = (b) => n.value = b),
