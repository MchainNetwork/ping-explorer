import { d as f, c as n, r as h, o as b, a as g, b as x, e, t as l, f as y, w as S, h as k, i as D } from "./main-b124380c.js";
import { I as V } from "./IdentityIcon-ed813c43.js";
const B = { class: "form-control" }, I = { class: "label" }, M = { class: "label-text" }, N = { class: "flex p-2" }, q = { class: "ml-2 text-base" }, w = { class: "form-control" }, R = { class: "label" }, U = { class: "label-text" }, z = ["placeholder"], J = /* @__PURE__ */ f({
  ...
  setup(o, { expose: c, emit: i }) {
    const r = o, a = (t) => D(r.locale || "en", t), u = n(() => JSON.parse(r.params || "{}")), s = h(""), m = n(() => [
      {
