import { d as E, c as m, r as i, o as F, a as v, b as p, e as t, t as n, f as q, w as k, v as V, F as D, g as T, G as z, H as J, I as G, p as H, h as L, i as P, j as $, J as K } from "./main-a00ca3ce.js";
import { T as N } from "./TokenUnitConverter-ddb5c664.js";
import { I as Q } from "./IdentityIcon-ebc7f7f3.js";
const R = { class: "form-control" }, W = { class: "label" }, X = { class: "label-text" }, Y = { class: "flex p-2" }, Z = { class: "ml-2 text-base" }, ee = { class: "form-control" }, ae = { class: "label" }, te = { class: "label-text" }, se = { value: "" }, oe = ["value"], ne = { key: 0 }, le = { class: "form-control" }, re = { class: "label" }, de = { class: "label-text" }, ie = { class: "join" }, ue = ["placeholder"], pe = /* @__PURE__ */ E({
  __name: "Delegate",
  props: {
  ...
  setup(b, { expose: U, emit: j }) {
    const o = b, r = (e) => P(o.locale || "en", e), x = m(() => JSON.parse(o.params || "{}")), c = i(""), g = i([]), B = i([]), d = i(""), I = i(""), _ = i(""), u = i(""), w = m(() => {
    ...
    function C() {
      h.value && h.value.focus(), g.value = [], c.value = x.value.validator_address, $(o.endpoint).then((e) => {
        d.value = e.params.bond_denom, I.value = e.params.unbonding_time;
      }), K(o.endpoint).then((e) => {
        var a;
    ...
    return F(() => {
      j("loaded");
    }), U({ msgs: w, isValid: M, initial: C }), (e, a) => {
      var l, f, S;
      return v(), p("div", null, [
        t("div", R, [
          t("label", W, [
        ...
        t("div", ee, [
          ...
          k(t("select", {
            ...
            (v(!0), p(D, null, T(O.value, (s) => (v(), p("option", {
              ...
              z(n(s.description.moniker) + " (" + n(J(G)(s.commission.commission_rates.rate)) + "%) ", 1),
              s.status !== "BOND_STATUS_BONDED" ? (v(), p("span", ne, "x")) : H("", !0)
            ], 8, oe))), 128))
          ], 512), [
            [V, c.value]
          ])
