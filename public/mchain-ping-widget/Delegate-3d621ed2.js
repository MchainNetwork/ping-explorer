import { d as z, c as m, r as i, o as F, a as v, b as p, e as t, t as n, f as q, w as k, v as D, F as T, g as N, z as $, D as G, E as H, p as J, h as L, i as P, G as K, j as Q, H as R } from "./main-e65e1b2c.js";
import { T as I } from "./TokenUnitConverter-a57e0ea9.js";
import { I as W } from "./IdentityIcon-0c6b3542.js";
const X = { class: "form-control" }, Y = { class: "label" }, Z = { class: "label-text" }, ee = { class: "flex p-2" }, ae = { class: "ml-2 text-base" }, te = { class: "form-control" }, se = { class: "label" }, oe = { class: "label-text" }, ne = { value: "" }, le = ["value"], re = { key: 0 }, de = { class: "form-control" }, ie = { class: "label" }, ue = { class: "label-text" }, ce = { class: "join" }, me = ["placeholder"], fe = /* @__PURE__ */ z({
  ...
  setup(b, { expose: U, emit: j }) {
    const o = b, r = (e) => P(o.locale || "en", e), x = m(() => JSON.parse(o.params || "{}")), c = i(""), g = i([]), V = i([]), d = i(""), w = i(""), _ = i(""), u = i(""), B = m(() => {
        ...
        t("div", te, [
          ...
          k(t("select", {
            ...
            (v(!0), p(T, null, N(A.value, (s) => (v(), p("option", {
              ...
              $(n(s.description.moniker) + " (" + n(G(H)(s.commission.commission_rates.rate)) + "%) ", 1),
              s.status !== "BOND_STATUS_BONDED" ? (v(), p("span", re, "x")) : J("", !0)
            ], 8, le))), 128))
          ], 512), [
            [D, c.value]
          ])
