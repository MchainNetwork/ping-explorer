import { d as z, c as m, r as i, o as F, a as v, b as p, e as t, t as n, f as q, w as k, v as D, F as T, g as N, y as $, z as G, D as J, p as L, h as P, i as H, E as K, j as Q, G as R } from "./main-32246275.js";
import { T as I } from "./TokenUnitConverter-12784101.js";
import { I as W } from "./IdentityIcon-62591963.js";
const X = { class: "form-control" }, Y = { class: "label" }, Z = { class: "label-text" }, ee = { class: "flex p-2" }, ae = { class: "ml-2 text-base" }, te = { class: "form-control" }, se = { class: "label" }, oe = { class: "label-text" }, ne = { value: "" }, le = ["value"], re = { key: 0 }, de = { class: "form-control" }, ie = { class: "label" }, ue = { class: "label-text" }, ce = { class: "join" }, me = ["placeholder"], fe = /* @__PURE__ */ z({
  __name: "Delegate",
  props: {
  ...
  setup(b, { expose: U, emit: j }) {
    const o = b, r = (e) => H(o.locale || "en", e), x = m(() => JSON.parse(o.params || "{}")), c = i(""), g = i([]), V = i([]), d = i(""), w = i(""), _ = i(""), u = i(""), B = m(() => {
      const e = new I(o.metadata);
      return [
        {
      ...
      var l;
      const e = new I(o.metadata), a = ((l = o.balances) == null ? void 0 : l.find((f) => f.denom === d.value)) || {
        amount: "0",
        denom: d.value
      };
      return {
    ...
    return F(() => {
      j("loaded");
    }), U({ msgs: B, isValid: E, initial: M }), (e, a) => {
      var l, f, S;
      return v(), p("div", null, [
        t("div", X, [
          t("label", Y, [
        ...
        t("div", te, [
          ...
          k(t("select", {
            ...
            (v(!0), p(T, null, N(A.value, (s) => (v(), p("option", {
              ...
              $(n(s.description.moniker) + " (" + n(G(J)(s.commission.commission_rates.rate)) + "%) ", 1),
              s.status !== "BOND_STATUS_BONDED" ? (v(), p("span", re, "x")) : L("", !0)
            ], 8, le))), 128))
          ], 512), [
            [D, c.value]
          ])
