import { d as z, c as m, r as i, o as C, a as v, b as p, e as t, t as n, f as F, w as k, v as V, F as D, g as T, y as q, z as J, D as L, p as P, h as $, i as G, j as H, E as K } from "./main-8a9bf3b2.js";
import { T as N } from "./TokenUnitConverter-2c885c97.js";
import { I as Q } from "./IdentityIcon-3f9aeb7d.js";
const R = { class: "form-control" }, W = { class: "label" }, X = { class: "label-text" }, Y = { class: "flex p-2" }, Z = { class: "ml-2 text-base" }, ee = { class: "form-control" }, ae = { class: "label" }, te = { class: "label-text" }, se = { value: "" }, oe = ["value"], ne = { key: 0 }, le = { class: "form-control" }, re = { class: "label" }, de = { class: "label-text" }, ie = { class: "join" }, ue = ["placeholder"], pe = /* @__PURE__ */ z({
  __name: "Delegate",
  props: {
  ...
  setup(b, { expose: U, emit: j }) {
    const o = b, r = (e) => G(o.locale || "en", e), x = m(() => JSON.parse(o.params || "{}")), c = i(""), g = i([]), B = i([]), d = i(""), w = i(""), _ = i(""), u = i(""), I = m(() => {
        ...
        t("div", ee, [
          ...
          k(t("select", {
            ...
            (v(!0), p(D, null, T(O.value, (s) => (v(), p("option", {
              ...
              q(n(s.description.moniker) + " (" + n(J(L)(s.commission.commission_rates.rate)) + "%) ", 1),
              s.status !== "BOND_STATUS_BONDED" ? (v(), p("span", ne, "x")) : P("", !0)
            ], 8, oe))), 128))
          ], 512), [
            [V, c.value]
          ])
