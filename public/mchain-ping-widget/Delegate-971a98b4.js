import { d as z, c as m, r as i, o as C, a as v, b as p, e as t, t as n, f as F, w as k, v as V, F as D, g as T, z as q, D as G, E as J, p as L, h as P, i as $, j as H, G as K } from "./main-45275fe0.js";
import { T as N } from "./TokenUnitConverter-e8fe839a.js";
import { I as Q } from "./IdentityIcon-a4ae70c2.js";
const R = { class: "form-control" }, W = { class: "label" }, X = { class: "label-text" }, Y = { class: "flex p-2" }, Z = { class: "ml-2 text-base" }, ee = { class: "form-control" }, ae = { class: "label" }, te = { class: "label-text" }, se = { value: "" }, oe = ["value"], ne = { key: 0 }, le = { class: "form-control" }, re = { class: "label" }, de = { class: "label-text" }, ie = { class: "join" }, ue = ["placeholder"], pe = /* @__PURE__ */ z({
  ...
  setup(b, { expose: U, emit: j }) {
    const o = b, r = (e) => $(o.locale || "en", e), x = m(() => JSON.parse(o.params || "{}")), c = i(""), g = i([]), B = i([]), d = i(""), w = i(""), _ = i(""), u = i(""), I = m(() => {
        ...
        t("div", ee, [
          ...
          k(t("select", {
            ...
            (v(!0), p(D, null, T(O.value, (s) => (v(), p("option", {
              ...
              q(n(s.description.moniker) + " (" + n(G(J)(s.commission.commission_rates.rate)) + "%) ", 1),
              s.status !== "BOND_STATUS_BONDED" ? (v(), p("span", ne, "x")) : L("", !0)
            ], 8, oe))), 128))
          ], 512), [
            [V, c.value]
          ])
