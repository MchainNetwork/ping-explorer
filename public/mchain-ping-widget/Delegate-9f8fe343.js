import { d as z, c as m, r as i, o as F, a as v, b as p, e as t, t as n, f as q, w as k, v as D, F as T, g as N, y as $, z as J, B as L, p as P, h as G, i as H, D as K, j as Q, E as R } from "./main-40332c7a.js";
import { T as B } from "./TokenUnitConverter-0e529b66.js";
...
const X = { class: "form-control" }, Y = { class: "label" }, Z = { class: "label-text" }, ee = { class: "flex p-2" }, ae = { class: "ml-2 text-base" }, te = { class: "form-control" }, se = { class: "label" }, oe = { class: "label-text" }, ne = { value: "" }, le = ["value"], re = { key: 0 }, de = { class: "form-control" }, ie = { class: "label" }, ue = { class: "label-text" }, ce = { class: "join" }, me = ["placeholder"], fe = /* @__PURE__ */ z({
  ...
  setup(b, { expose: I, emit: U }) {
    const o = b, r = (e) => H(o.locale || "en", e), x = m(() => JSON.parse(o.params || "{}")), c = i(""), g = i([]), V = i([]), d = i(""), j = i(""), _ = i(""), u = i(""), w = m(() => {
    ...
    return F(() => {
      U("loaded");
    }), I({ msgs: w, isValid: E, initial: M }), (e, a) => {
      var l, f, S;
      return v(), p("div", null, [
        t("div", X, [
          t("label", Y, [
