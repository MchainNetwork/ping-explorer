import { d as b, c as r, r as h, o as g, a as x, b as y, e, t as l, f as k, w as S, h as z, i as D } from "./main-8f814044.js";
import { I as N } from "./IdentityIcon-3e05cedf.js";
const V = { class: "form-control" }, A = { class: "label" }, B = { class: "label-text" }, I = { class: "flex p-2" }, M = { class: "ml-2 text-base" }, Z = { class: "form-control" }, q = { class: "label" }, w = { class: "label-text" }, U = ["placeholder"], J = /* @__PURE__ */ b({
  ...
  setup(n, { expose: i, emit: c }) {
    const o = n, a = (t) => D(o.locale, t), u = r(() => JSON.parse(o.params || "{}")), s = h(""), m = r(() => [
      {
