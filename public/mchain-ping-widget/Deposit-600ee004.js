import { d as V, c as u, r as m, o as B, a as b, b as g, e as t, t as d, f as M, w as x, h as N, v as j, F as O, g as q, i as z, j as C } from "./main-a0451e5b.js";
import { T as S } from "./TokenUnitConverter-5c501082.js";
import { I as F } from "./IdentityIcon-49e1a1a6.js";
const A = { class: "form-control" }, E = { class: "label" }, J = { class: "label-text" }, L = { class: "flex p-2" }, P = { class: "ml-2 text-base" }, $ = { class: "form-control" }, G = { class: "label" }, H = { class: "label-text" }, K = { class: "input-group" }, Q = ["placeholder"], Y = /* @__PURE__ */ V({
  ...
  setup(v, { expose: k, emit: I }) {
    const s = v, i = (e) => z(s.locale, e), y = u(() => JSON.parse(s.params || "{}")), o = m(""), c = m(""), l = m(""), _ = u(() => {
      var n;
