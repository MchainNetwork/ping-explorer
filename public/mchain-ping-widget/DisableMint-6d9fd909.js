import { d as h, c as r, r as i, o as y, a as g, b as x, e, t as d, f as S, w as k, h as M, i as D } from "./main-8f814044.js";
import { I as V } from "./IdentityIcon-3e05cedf.js";
const w = { class: "form-control" }, B = { class: "label" }, I = { class: "label-text" }, N = { class: "flex p-2" }, O = { class: "ml-2 text-base" }, j = { class: "form-control" }, q = { class: "label" }, U = { class: "label-text" }, E = /* @__PURE__ */ h({
  ...
  setup(l, { expose: c, emit: u }) {
    const a = l, n = (s) => D(a.locale, s), m = r(() => JSON.parse(a.params || "{}")), o = i(m.value.denom || ""), p = i(""), _ = r(() => [
      {
