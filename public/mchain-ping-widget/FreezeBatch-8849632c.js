...
const z = { class: "form-control" }, M = { class: "label" }, N = { class: "label-text" }, O = { class: "flex p-2" }, U = { class: "ml-2 text-base" }, j = { class: "form-control" }, q = { class: "label" }, D = { class: "label-text" }, F = { class: "form-control" }, C = { class: "label" }, E = { class: "label-text" }, A = /* @__PURE__ */ g({
  __name: "FreezeBatch",
  props: {
  ...
  setup(d, { expose: f, emit: b }) {
    const l = d, t = (a) => V(l.locale || "en", a), v = u(() => JSON.parse(l.params || "{}")), r = m(v.value.denom || ""), n = m(""), y = u(() => [
      {
...
`)
    ...
    return k(() => {
      ...
      e("div", z, [
        e("label", M, [
          e("span", N, o(t("your_connected_account")), 1)
        ]),
        e("div", O, [
          I(w, {
            size: "small",
      ...
      e("div", F, [
        e("label", C, [
          e("span", E, o(t("addresses")) + " (" + o(t("one_address_per_line")) + ") ", 1)
        ]),
        p(e("textarea", {
          ref_key: "focusInput",
          ref: c,
