import { d as C, c as g, r as u, I as F, o as M, a as r, b as n, e, w as d, h as c, F as y, g as f, v as N, t as O } from "./main-c2a72820.js";
...
], -1), z = { class: "form-control" }, G = /* @__PURE__ */ e("span", { class: "label-text" }, "Funds", -1), H = ["onUpdate:modelValue"], K = ["onUpdate:modelValue"], P = ["value"], R = /* @__PURE__ */ C({
  ...
  setup(i, { expose: _, emit: h }) {
    ...
    return M(() => {
      ...
      e("div", z, [
        ...
        (r(!0), n(y, null, f(l.value, (t, I) => (r(), n("label", {
          class: "input-group",
          key: I
        }, [
          d(e("input", {
