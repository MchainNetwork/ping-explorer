import { d as ue, r as a, c as C, o as ie, a as c, b as p, e, t as n, f as de, w as r, h as v, u as x, p as b, i as ce, x as N, y as pe } from "./main-dcfa34f6.js";
import { I as me } from "./IdentityIcon-5797a91d.js";
const ve = { class: "form-control" }, be = { class: "label" }, _e = { class: "label-text" }, fe = { class: "flex p-2" }, ye = { class: "ml-2 text-base" }, ke = { class: "md:flex items-center justify-between gap-2" }, he = { class: "form-control md:flex-1 mb-2" }, ge = { class: "label" }, xe = { class: "label-text" }, Se = { class: "form-control md:ml-2 mb-2" }, Ve = { class: "label" }, we = { class: "label-text" }, Ie = { class: "form-control" }, Re = { class: "label cursor-pointer" }, Ce = { class: "label-text" }, Ne = { class: "grid grid-cols-1 md:grid-cols-3 gap-2 p-2" }, Ue = { class: "cursor-pointer flex items-center mb-2" }, Be = ["value"], Me = { class: "label-text" }, Fe = { class: "cursor-pointer flex items-center mb-2" }, ze = ["value"], Te = { class: "label-text" }, qe = { class: "cursor-pointer flex items-center mb-2" }, De = ["value"], $e = { class: "label-text" }, je = { class: "cursor-pointer flex items-center mb-2" }, Ee = ["value"], Le = { class: "label-text" }, Oe = { class: "cursor-pointer flex items-center mb-2" }, Pe = ["value"], Ae = { class: "label-text" }, Ge = { class: "cursor-pointer flex items-center mb-2" }, He = ["value"], Je = { class: "label-text" }, Ke = { class: "form-control text-right" }, Qe = { class: "label" }, We = { class: "label-text" }, Xe = {
  key: 0,
  class: "p-2"
}, Ye = {
  key: 1,
  ...
  setup(U, { expose: O, emit: P }) {
    const S = U, t = (o) => ce(S.locale || "en", o), A = {
      ...
      whitelist: 4,
      freezing: 5
    }, y = a(""), w = a(""), V = a(""), m = a("6"), d = a("0"), _ = a("0"), G = a(""), B = a("0"), M = a("0"), F = a("0"), z = a("0"), T = a({}), H = C(() => u.value.map(
      //@ts-ignore
      (o) => i[A[o]]
    )), u = a([]), J = C(
    ...
    const te = C(() => {
      ...
      const o = Number(d.value) * Math.pow(10, Number(m.value)), l = Number(_.value) * Math.pow(10, Number(m.value)), s = R(B.value), L = R(M.value), oe = R(F.value), re = R(z.value);
      return [
        {
      ...
      I.value ? (c(), p("div", ol, [
        ...
        e("div", ml, [
          ...
          r(e("input", {
            ...
            ref: W,
            "onUpdate:modelValue": l[13] || (l[13] = (s) => F.value = s),
            class: "input input-sm border border-gray-300 dark:border-gray-600 w-20 rounded-full"
          }, null, 512), [
            [v, F.value]
          ])
        ...
        e("div", _l, [
          ...
          r(e("input", {
            ...
            ref: X,
            "onUpdate:modelValue": l[14] || (l[14] = (s) => z.value = s),
            class: "input input-sm border border-gray-300 dark:border-gray-600 w-20 rounded-full"
          }, null, 512), [
            [v, z.value]
          ])
