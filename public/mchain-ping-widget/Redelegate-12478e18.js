import { d as I, c as d, r, D as T, o as q, a as v, b as m, e as a, t as n, f as R, w as x, v as B, F as U, g as w, y as G, z as J, p as L, h as P, i as H, G as K, j as Q, E as W } from "./main-3a98310b.js";
import { T as A } from "./TokenUnitConverter-f0b2f48f.js";
import { I as X } from "./IdentityIcon-d287570e.js";
const Y = { class: "form-control" }, Z = { class: "label" }, ee = { class: "label-text" }, ae = { class: "flex p-2" }, te = { class: "ml-2 text-base" }, se = { class: "form-control" }, oe = { class: "label" }, ne = { class: "label-text" }, le = ["value"], re = { class: "form-control" }, de = { class: "label" }, ie = { class: "label-text" }, ce = { value: "" }, ue = ["value"], ve = { key: 0 }, me = { class: "form-control" }, pe = { class: "label" }, _e = { class: "label-text" }, be = { class: "input-group" }, ge = ["placeholder"], fe = { class: "text-error" }, ke = /* @__PURE__ */ I({
  ...
  setup(f, { expose: O, emit: E }) {
    const o = f, l = (e) => H(o.locale || "en", e), _ = d(() => JSON.parse(o.params || "{}")), p = r(""), h = r([]), M = r([]), i = r(""), b = r(""), c = r(""), y = r({}), k = r(""), S = d(() => {
        ...
        a("div", re, [
          ...
          x(a("select", {
            ...
            (v(!0), m(U, null, w(j.value, (s) => (v(), m("option", {
              ...
              G(n(s.description.moniker) + " (" + n(J(T)(s.commission.commission_rates.rate)) + "%) ", 1),
