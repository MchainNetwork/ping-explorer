import { d as q, c as d, r, G as T, o as z, a as v, b as m, e as a, t as n, f as R, w as x, v as B, F as U, g as w, D as G, E as H, p as J, h as L, i as P, I as K, j as Q, H as W } from "./main-dcfa34f6.js";
import { T as A } from "./TokenUnitConverter-5c47a9e6.js";
import { I as X } from "./IdentityIcon-5797a91d.js";
const Y = { class: "form-control" }, Z = { class: "label" }, ee = { class: "label-text" }, ae = { class: "flex p-2" }, te = { class: "ml-2 text-base" }, se = { class: "form-control" }, oe = { class: "label" }, ne = { class: "label-text" }, le = ["value"], re = { class: "form-control" }, de = { class: "label" }, ie = { class: "label-text" }, ce = { value: "" }, ue = ["value"], ve = { key: 0 }, me = { class: "form-control" }, pe = { class: "label" }, _e = { class: "label-text" }, be = { class: "input-group" }, ge = ["placeholder"], fe = { class: "text-error" }, ke = /* @__PURE__ */ q({
  ...
  setup(f, { expose: O, emit: E }) {
    const o = f, l = (e) => P(o.locale || "en", e), _ = d(() => JSON.parse(o.params || "{}")), p = r(""), h = r([]), I = r([]), i = r(""), b = r(""), c = r(""), y = r({}), k = r(""), S = d(() => {
    ...
    return z(() => {
      E("loaded");
    }), O({ msgs: M, isValid: C, initial: F }), (e, t) => {
      var u, V, D, N;
      return v(), m("div", null, [
        a("div", Y, [
          a("label", Z, [
