import { d as q, c as d, r, y as N, o as z, a as v, b as m, e as a, t as n, f as R, w as x, v as T, F as U, g as w, u as J, x as L, p as P, h as G, i as H, D as K, j as Q, B as W } from "./main-6f623a49.js";
import { T as A } from "./TokenUnitConverter-224d1a76.js";
import { I as X } from "./IdentityIcon-9dc0c59f.js";
const Y = { class: "form-control" }, Z = { class: "label" }, ee = { class: "label-text" }, ae = { class: "flex p-2" }, te = { class: "ml-2 text-base" }, se = { class: "form-control" }, oe = { class: "label" }, ne = { class: "label-text" }, le = ["value"], re = { class: "form-control" }, de = { class: "label" }, ie = { class: "label-text" }, ce = { value: "" }, ue = ["value"], ve = { key: 0 }, me = { class: "form-control" }, pe = { class: "label" }, _e = { class: "label-text" }, be = { class: "input-group" }, ge = ["placeholder"], fe = { class: "text-error" }, ke = /* @__PURE__ */ q({
  ...
  setup(f, { expose: O, emit: M }) {
    const o = f, l = (e) => H(o.locale, e), _ = d(() => JSON.parse(o.params || "{}")), p = r(""), h = r([]), $ = r([]), i = r(""), b = r(""), c = r(""), y = r({}), k = r(""), S = d(() => {
    ...
    return z(() => {
      M("loaded");
    }), O({ msgs: j, isValid: F, initial: I }), (e, t) => {
      var u, V, D, B;
      return v(), m("div", null, [
        a("div", Y, [
          a("label", Z, [
        ...
        a("div", re, [
          ...
          x(a("select", {
            ...
            (v(!0), m(U, null, w(C.value, (s) => (v(), m("option", {
              ...
              J(n(s.description.moniker) + " (" + n(L(N)(s.commission.commission_rates.rate)) + "%) ", 1),
              s.status !== "BOND_STATUS_BONDED" ? (v(), m("span", ve, "x")) : P("", !0)
            ], 8, ue))), 128))
          ], 512), [
            [T, p.value]
          ])
