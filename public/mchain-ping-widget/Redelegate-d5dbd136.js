import { d as I, c as d, r, D as T, o as q, a as v, b as m, e as a, t as n, f as R, w as x, v as B, F as U, g as w, y as G, z as H, p as J, h as L, i as P, H as K, j as Q, G as W } from "./main-b124380c.js";
import { T as A } from "./TokenUnitConverter-f6a69529.js";
import { I as X } from "./IdentityIcon-ed813c43.js";
const Y = { class: "form-control" }, Z = { class: "label" }, ee = { class: "label-text" }, ae = { class: "flex p-2" }, te = { class: "ml-2 text-base" }, se = { class: "form-control" }, oe = { class: "label" }, ne = { class: "label-text" }, le = ["value"], re = { class: "form-control" }, de = { class: "label" }, ie = { class: "label-text" }, ce = { value: "" }, ue = ["value"], ve = { key: 0 }, me = { class: "form-control" }, pe = { class: "label" }, _e = { class: "label-text" }, be = { class: "input-group" }, ge = ["placeholder"], fe = { class: "text-error" }, ke = /* @__PURE__ */ I({
  ...
  emits: ["loaded"],
  setup(f, { expose: O, emit: M }) {
    const o = f, l = (e) => P(o.locale || "en", e), _ = d(() => JSON.parse(o.params || "{}")), p = r(""), h = r([]), $ = r([]), i = r(""), b = r(""), c = r(""), y = r({}), k = r(""), S = d(() => {
    ...
    return q(() => {
      M("loaded");
    }), O({ msgs: j, isValid: E, initial: F }), (e, t) => {
      var u, V, D, N;
      return v(), m("div", null, [
        a("div", Y, [
          a("label", Z, [
        ...
        a("div", re, [
          ...
          x(a("select", {
            ...
            (v(!0), m(U, null, w(z.value, (s) => (v(), m("option", {
              ...
              G(n(s.description.moniker) + " (" + n(H(T)(s.commission.commission_rates.rate)) + "%) ", 1),
              s.status !== "BOND_STATUS_BONDED" ? (v(), m("span", ve, "x")) : J("", !0)
            ], 8, ue))), 128))
          ], 512), [
            [B, p.value]
          ])
