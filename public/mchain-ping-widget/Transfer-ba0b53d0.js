import { m as ut, n as lt, d as ft, c as q, r as N, o as ht, a as A, b as E, e as h, t as S, f as mt, w as K, v as nt, F as st, g as at, p as vt, h as rt, i as pt, q as $t, j as _t, C as gt } from "./main-cc910e20.js";
import { T as it } from "./TokenUnitConverter-66156a58.js";
import { I as yt } from "./IdentityIcon-e76b9c9f.js";
var ct = { exports: {} };
(function(J, tt) {
  (function(H, v) {
    J.exports = v();
...
const Mt = /* @__PURE__ */ ut(Dt), St = { class: "form-control" }, Ot = { class: "label" }, xt = { class: "label-text" }, Tt = { class: "flex p-2" }, wt = { class: "ml-2 text-base" }, Ct = { class: "form-control" }, Ut = { class: "label" }, Yt = { class: "label-text" }, kt = { value: "" }, Ht = ["value"], It = { class: "form-control" }, Lt = { class: "label" }, Vt = { class: "label-text" }, Wt = {
  ...
  setup(J, { expose: tt, emit: H }) {
    const v = J;
    ot.extend(Mt);
    const D = (u) => pt(v.locale, u), P = q(() => JSON.parse(v.params || "{}")), U = P.value.chain_name, b = N(""), c = N(""), O = N(""), p = N(""), y = N(""), Z = N([]), $ = N(
      {}
    ), C = N(
      {}
    ), a = new gt(), x = q(() => {
