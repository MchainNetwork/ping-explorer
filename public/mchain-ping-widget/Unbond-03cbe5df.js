import { d as V, c as d, r as m, o as B, a as _, b, e as t, t as i, f as M, w as f, h as N, v as I, F as q, g as z, i as A, D as C } from "./main-c2a72820.js";
import { T as h } from "./TokenUnitConverter-c871ef4a.js";
import { I as F } from "./IdentityIcon-f38133db.js";
const O = { class: "form-control" }, j = { class: "label" }, E = { class: "label-text" }, J = { class: "flex p-2" }, L = { class: "ml-2 text-base" }, $ = { class: "form-control" }, G = { class: "label" }, H = { class: "label-text" }, K = { class: "input-group" }, P = ["placeholder"], Q = { class: "text-error" }, Y = /* @__PURE__ */ V({
  __name: "Unbond",
  props: {
        ...
        t("div", $, [
          ...
          t("label", K, [
            f(t("input", {
              ...
              type: "number",
              placeholder: l("available") + `: ${(o = D.value.display) == null ? void 0 : o.amount}`,
