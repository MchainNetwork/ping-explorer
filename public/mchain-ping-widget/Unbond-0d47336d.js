import { d as B, c, r as p, o as D, a as g, b as f, e as t, t as r, f as M, w as h, h as N, v as C, F as I, g as q, i as z, K as F } from "./main-a00ca3ce.js";
import { T as x } from "./TokenUnitConverter-ddb5c664.js";
import { I as O } from "./IdentityIcon-ebc7f7f3.js";
const j = { class: "form-control" }, E = { class: "label" }, J = { class: "label-text" }, K = { class: "flex p-2" }, L = { class: "ml-2 text-base" }, $ = { class: "form-control" }, G = { class: "label" }, H = { class: "label-text" }, P = { class: "input-group" }, Q = ["placeholder"], R = { class: "text-error" }, Z = /* @__PURE__ */ B({
  __name: "Unbond",
  props: {
