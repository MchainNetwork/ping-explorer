import { d as B, c as d, r as m, o as D, a as _, b, e as t, t as i, f as M, w as f, h as N, v as I, F as q, g as z, i as A, H as C } from "./main-37357ec9.js";
import { T as h } from "./TokenUnitConverter-e271bcec.js";
import { I as F } from "./IdentityIcon-f3f12738.js";
const O = { class: "form-control" }, j = { class: "label" }, E = { class: "label-text" }, H = { class: "flex p-2" }, J = { class: "ml-2 text-base" }, L = { class: "form-control" }, $ = { class: "label" }, G = { class: "label-text" }, K = { class: "input-group" }, P = ["placeholder"], Q = { class: "text-error" }, Y = /* @__PURE__ */ B({
  __name: "Unbond",
  props: {
