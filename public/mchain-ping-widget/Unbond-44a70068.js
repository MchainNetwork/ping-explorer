import { d as B, c, r as p, o as D, a as g, b as f, e as t, t as r, f as M, w as h, h as N, v as C, F as I, g as q, i as z, H as F } from "./main-45275fe0.js";
import { T as x } from "./TokenUnitConverter-e8fe839a.js";
import { I as O } from "./IdentityIcon-a4ae70c2.js";
const j = { class: "form-control" }, E = { class: "label" }, H = { class: "label-text" }, J = { class: "flex p-2" }, L = { class: "ml-2 text-base" }, $ = { class: "form-control" }, G = { class: "label" }, K = { class: "label-text" }, P = { class: "input-group" }, Q = ["placeholder"], R = { class: "text-error" }, Z = /* @__PURE__ */ B({
  __name: "Unbond",
  props: {
  ...
  setup(v, { expose: k, emit: S }) {
    ...
    return D(() => {
      ...
      return g(), f("div", null, [
        t("div", j, [
          t("label", E, [
            t("span", H, r(l("your_connected_account")), 1)
          ]),
          t("div", J, [
            M(O, {
              size: "small",
