import { d as B, c as d, r as m, o as D, a as _, b, e as t, t as i, f as M, w as f, h as N, v as I, F as q, g as z, i as A, E as C } from "./main-0ee6a5c8.js";
import { T as h } from "./TokenUnitConverter-e59c350a.js";
import { I as E } from "./IdentityIcon-55514251.js";
const F = { class: "form-control" }, O = { class: "label" }, j = { class: "label-text" }, J = { class: "flex p-2" }, L = { class: "ml-2 text-base" }, $ = { class: "form-control" }, G = { class: "label" }, H = { class: "label-text" }, K = { class: "input-group" }, P = ["placeholder"], Q = { class: "text-error" }, Y = /* @__PURE__ */ B({
  __name: "Unbond",
  props: {
  ...
  setup(p, { expose: y, emit: x }) {
    ...
    return D(() => {
      ...
      return _(), b("div", null, [
        t("div", F, [
          t("label", O, [
            t("span", j, i(l("your_connected_account")), 1)
          ]),
          t("div", J, [
            M(E, {
              size: "small",
