import { d as f, c as i, r as g, o as h, a as b, b as y, e as o, t as c, f as w, i as x, I as S } from "./main-014f4388.js";
...
const V = { class: "form-control" }, k = { class: "label" }, A = { class: "label-text" }, B = { class: "flex p-2" }, C = { class: "ml-2 text-base" }, N = /* @__PURE__ */ f({
  ...
  setup(d, { expose: u, emit: m }) {
    const s = d, t = (e) => x(s.locale, e), n = i(() => JSON.parse(s.params || "{}")), r = g(
      []
    ), p = i(() => {
      var a;
      return [
