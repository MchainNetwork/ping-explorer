...
<template>
  <div class="progress rounded-[3px] h-6 text-xs flex items-center">
    <div
      class="h-6 bg-yes flex items-center pl-2 text-white dark:text-black overflow-hidden"
      :style="`width: ${yes}`"
      :title="yes"
    >
      {{ yes }}
    ...
    <div
      class="h-6 bg-no flex items-center text-white dark:text-black overflow-hidden"
      :style="`width: ${no}`"
      :title="no"
    >
      {{ no }}
    ...
    <div
      class="h-6 bg-[#B71C1C] flex items-center text-white dark:text-black overflow-hidden"
      :style="`width: ${veto};`"
      :title="veto"
    >
      {{ veto }}
    ...
    <div
      class="h-6 bg-secondary flex items-center text-white dark:text-black overflow-hidden"
      :style="`width: ${abstain}`"
      :title="abstain"
    >
      {{ abstain }}
