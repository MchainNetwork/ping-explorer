...
<template>
  <div class="">
    <div class="px-4 pt-3 pb-4 bg-base-200 rounded-xl mb-4">
    ...
    <div class="bg-base-100 px-4 pt-3 pb-4 rounded-xl mb-4 overflow-hidden">
          ...
          <tr v-for="resp in txs?.tx_responses">
            ...
            <td>
              <div class="flex">
                ...
                />
                <Icon v-else icon="uil:multiply" class="text-error text-lg" />
              </div>
            </td>
