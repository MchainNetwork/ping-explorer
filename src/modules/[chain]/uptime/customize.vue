...
<template>
  <div>
    <div class="overflow-x-auto w-full">
      <div
        class="lg:!flex lg:!items-center lg:!justify-between bg-base-100 rounded-xl p-5"
      >
    ...
    <div class="text-center">
      <label for="add-validator" class="btn btn-primary rounded-full mt-5">{{
    ...
    <div class="modal">
      <div class="modal-box relative">
        ...
        <div class="modal-action">
          <label class="btn btn-primary rounded-full" @click="add">{{
            $t('uptime.add')
          }}</label>
        </div>
      </div>
