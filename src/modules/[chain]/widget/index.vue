...
const pingWidgetJs = host + '/mchain-ping-widget/ping-widget.js';
</script>
<template>
  <div class="mx-auto max-w-screen-lg">
    <h1 class="text-4xl font-bold mb-6 p-4">Widgets</h1>
    <div class="bg-base-100 px-4 pt-3 pb-4 rounded-xl">
        ...
        <div class="form-control">
          <div class="input-group">
            ...
            <select v-model="endpoint" class="select select-bordered w-fit">
              ...
              <option
                :key="index"
                v-for="(v, index) in chainStore.current?.endpoints.rest"
                :value="v.address"
              >
                {{ v.address }}
              </option>
      ...
      <div class="mockup-code bg-base-200 my-2">
        <pre
          data-prefix="1"
        ><code class="text-gray-800 dark:invert">&lt;script type="module" src="{{ pingWidgetJs}}"&gt;</code></pre>
      </div>
    </div>
    <div class="bg-base-100 my-5 px-4 pt-3 pb-4 rounded-xl">
      ...
      <div class="mt-4">
        ...
        <span class="text-base"> 2. Tx Dialog</span>
        <div class="mockup-code bg-base-200 my-2">
          <pre
            data-prefix=">"
          ><code class=" text-gray-800 dark:invert">&lt;ping-tx-dialog chain-name="{{ chainName }}" endpoint="{{endpoint}}" hd-path="{{hdPath}}"/&gt;</code></pre>
          <pre
            data-prefix=">"
          ><code class="text-gray-800 dark:invert">&lt;label for="PingTxDialog" class="btn btn-sm"&gt;Buy MAR&lt;/label&gt;</code></pre>
        </div>
        ...
        <div class="mockup-code bg-base-200 my-2">
          ...
          <pre
            data-prefix=">"
          ><code class="text-gray-800 dark:invert">&lt;label for="PingTokenConvert" class="btn btn-sm"&gt;Buy MAR&lt;/label&gt;</code></pre>
        </div>
      </div>
    </div>
  </div>
