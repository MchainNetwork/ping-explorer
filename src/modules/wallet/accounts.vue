    ...
    <div class="overflow-x-auto">
      <div v-for="{ key, subaccounts } in accounts" class="bg-base-100 rounded-md my-5 py-5">
        <div class="flex justify-self-center">
          <div class="mx-2 p-2">
            <svg :fill="chainStore.current?.themeColor || '#0099bf'" height="28px" width="28px" version="1.1" id="Capa_1"
          ...
          <div>
            ...
            <div class="dropdown">
              ...
              <ul tabindex="0" class=" -left-14 dropdown-content menu p-2 bg-base-200 rounded-box z-50">
